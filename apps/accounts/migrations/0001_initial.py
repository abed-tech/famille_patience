    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Administrateur'), ('counsellor', 'Conseiller'), ('referrer', 'Référent'), ('member', 'Membre'), ('attendance_agent', 'Agent de pointage')], default='member', max_length=20, verbose_name='Rôle')),
